...
function draw() {
  ...
  line(0, ythreshold, 19, ythreshold);
    ...
    push();
    image(img1, width/8, height/3, img1.width/4, img1.height/4);
    image(img2, width/2.5, height/3, img2.width/4, img2.height/4);
    image(img3, width/1.5, height/3, img3.width/4, img3.height/4);
    pop();  
